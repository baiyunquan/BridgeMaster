...
const dictionary: Dictionary = {
  ...
  turnToLead: { zh: "轮到 {position} 首攻", en: "{position} To Lead" },
  turnToPlayCard: { zh: "轮到 {position} 出牌", en: "{position} To Play" },
  ...
  eventAssistantContractSet: { zh: "辅助模式定约已更新", en: "Assistant Contract Updated" },
  eventAssistantCardsUpdated: { zh: "辅助模式手牌已更新", en: "Assistant Known Cards Updated" },
  eventAssistantPlayUpdated: { zh: "辅助模式出牌已更新", en: "Assistant Play Updated" },
  eventAssistantReset: { zh: "辅助模式牌局已重置", en: "Assistant Board Reset" },
